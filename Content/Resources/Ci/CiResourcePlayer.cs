...
namespace Cultivators.Content.Resources.Ci
{
    public class CiResourcePlayer : ModPlayer
    {
        ...
        public static void SendExampleResourceEffectMessage(int whoAmI, int healAmount)
        {
            ...
            ModPacket packet = ModContent.GetInstance<Cultivators>().GetPacket();
            packet.Write((byte)Cultivators.MessageType.ExampleResourceEffect);
