using Cultivators.Content.Items.ElementalProjectiles;
...
{
    public class BookOfBloodThorns : BaseCiWeapon
    {
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<BloodThornsProjectile>();
            Item.shootSpeed = 7;
            Item.crit = 32;
